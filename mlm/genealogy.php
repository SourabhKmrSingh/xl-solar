...

{
    ...
    global $db, $direct, $FILE_LOC, $validation,$membership_id;

   

    $treeResult = $db->view('membership_id,imgName,username,status,mobile', 'mlm_registrations', 'regid', "and sponsor_id='$parent'", 'regid asc');
...

	{
...

		{
			...
			if($membership_id == $parent){
				echo "<p> ( " . $validation->db_field_validate($treeRow['mobile'])." ) </p>";
			}
