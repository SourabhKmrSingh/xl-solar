...
$where_query = " and membership_id='{$_SESSION['mlm_membership_id']}'";
	...
	<div ID="wrapper">
		...
		<div ID="page-wrapper">
			<div CLASS="container-fluid">
				<div CLASS="row">
					<div CLASS="col-lg-12">
						<h1 CLASS="page-header"> Activate Account <a href="active_account_form.php?mode=insert&membershipid=<?php echo $data['result'][0]['membership_id'];?>" class="btn btn-default btn-sm button">Activate Account</a></h1>
					</div>
				</div>
