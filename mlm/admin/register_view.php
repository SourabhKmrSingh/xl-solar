				...
				<div CLASS="row">
					<div CLASS="col-lg-12">
						<h1 CLASS="page-header">Members
							<!--<?php if ($_SESSION['per_write'] == "1") { ?><a href="register_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?>-->
						</h1>
					</div>
				</div>
						...
						<table class="table table-striped table-view" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th class="<?php echo $th_sort1 . " " . $th_order_cls1; ?>"><a href="register_view.php?orderby=first_name&order=<?php echo $th_order1;
																																				echo $url_parameters; ?>"><span>Name</span> <span class="sorting-indicator"></span></a></th>
									<th>Membership ID</th>
									<th>Sponsor ID</th>
									<th>Email</th>
									<th>Mobile No.</th>
								...
								?>
										<tr class="text-center has-row-actions">
												...
												<div class="row row-actions">
													<div class="col-sm-12">
														...
														<?php if ($_SESSION['per_delete'] == "1") { ?>
															...
															|
														<?php } ?>
														<a href="genealogy.php?regid=<?php echo $validation->db_field_validate($registerRow['regid']); ?>">Genealogy</a> | <br>
														<a href="member_details.php?regid=<?php echo $validation->db_field_validate($registerRow['regid']); ?>" target="_blank">Member details (pdf)</a>
													</div>
												</div>
											</td>
											...
											<td data-label="Status - ">
												<font color="<?php if ($registerRow['status'] == "active") {
																	echo "green";
																} else {
																	echo "red";
																} ?>"><?php echo $validation->db_field_validate(ucfirst($registerRow['status'])); ?></font>
											</td>
