...
<div class="form-rows-custom mt-3">
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="site_url_web">Main Website Address (URL) *</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="site_url_web" id="site_url_web" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['site_url_web']); ?>" required />
		</div>
	</div>
	...
	<!-- <h5 class="mb-4 mt-5">Referral Settings</h5>
	
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="referral_amount">Referral Amount</label>
		</div>
		<div class="col-sm-9">
			<input type="number" name="referral_amount" id="referral_amount" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['referral_amount']); ?>" />
		</div>
	</div> -->
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="admin_rate">Admin</label>
		</div>
		<div class="col-sm-9">
			<input type="number" name="admin_rate" id="admin_rate" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['admin_rate']); ?>" />
			<em class="d-block mt-1">In Percentage</em>
		</div>
	</div>
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="tax_rate">TDS</label>
		</div>
		<div class="col-sm-9">
			<input type="number" name="tax_rate" id="tax_rate" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['tax_rate']); ?>" />
			<em class="d-block mt-1">In Percentage</em>
		</div>
	</div>
