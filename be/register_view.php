...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Registrations <?php if($_SESSION['per_write'] == "1") { ?><a href="register_form.php?mode=insert" class="btn btn-default btn-sm button">Add New</a><?php } ?></h1>
	</div>
</div>
