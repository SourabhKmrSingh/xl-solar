				...
				<?php if($mode == 'edit') { ?>
					...
					?>
						...
						<tr>
							...
							<td><input type="number" name="price[]" id="price" class="form-control" value="<?php echo $validation->db_field_validate($variantRow['price']); ?>" step="any" required /></td>
							<td><input type="number" name="mrp[]" id="mrp" class="form-control" value="<?php echo $validation->db_field_validate($variantRow['mrp']); ?>" step="any" /></td>
					...
					?>
						<tr>
							...
							<td><input type="number" name="price[]" id="price" class="form-control" step="any" required /></td>
							<td><input type="number" name="mrp[]" id="mrp" class="form-control" step="any" /></td>
