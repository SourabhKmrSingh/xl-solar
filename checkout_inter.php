...
if($purchasetempResult['num_rows'] >= 1 and $cartResult['num_rows'] >= 1)
{
	...
	foreach($cartResult['result'] as $cartRow)
	{
		...
		$message = "Hi {$billing_first_name} {$billing_last_name}, \n\nYour Order for {$product_title} has been successfully placed with Order ID : {$refno_custom}. \n\nFor futher details login to you account and check orders Section. \n\nThank you\nXL Solar";
